...
import { type FileState } from "@/app/portaal/AdmissionForm"; // REGSTELLING: Pad opgedateer
...
function mapDataToSchema(textData: TextData, applicationId: string) {
    ...
    const learnerData = {
        ...
        signature: textData.acceptHandtekening,
    };
...
export async function POST(request: Request) {
    ...
    try {
        ...
        human_friendly_id = `BRI-${formattedDate}-${paddedAppNumber}`;
