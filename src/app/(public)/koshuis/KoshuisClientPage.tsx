...
import KoshuisPakketAd from "../KoshuisPakketAd"; // <-- Ons voer die advertensie in
...
export default function KoshuisClientPage({
    ...
    return (
        <div className="flex flex-col bg-white">
            ...
            >
                <Image
                    src="/wapen.jpg" // Placeholder: Ons kort 'n goeie koshuis-foto
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="prose prose-lg prose-zinc mx-auto max-w-3xl text-center prose-strong:text-rose-900 prose-h2:text-rose-900">
                        ...
                        <p className="mt-6 leading-8 text-zinc-700">
                            Ons koshuis bied 'n veilige, ondersteunende en gedissiplineerde omgewing waar leerders kan floreer. Met moderne fasiliteite, gebalanseerde etes, en toegewyde personeel, verseker ons dat elke koshuisleerder deel van die familie voel.
                        </p>
                        {/* Ons kan hier meer statiese inligting byvoeg (bv. Fasiliteite, Reëls) */}
                    </div>
                </div>
            </motion.section>
            ...
            >
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    {/* Hergebruik die advertensie-komponent */}
                    <KoshuisPakketAd />
                </div>
            </section>
