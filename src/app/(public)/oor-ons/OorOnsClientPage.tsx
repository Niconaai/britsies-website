        ...
        <div className="flex flex-col bg-white">
            ...
            >
                <Image
                    ...
                    priority
                />
                <div className="absolute inset-0 bg-rose-900/5 z-5"></div>
                <motion.div
            ...
            >
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    {/* REGSTELLING: Bygevoeg 'prose-h2:text-rose-900' */}
                    ...
                    <div className="space-y-16 lg:space-y-24">
                        ...
                        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:items-center">
                            ...
                            <div className="prose prose-lg prose-zinc prose-h2:text-rose-900">
                                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-rose-900 text-center">
                                ...
                                <p className="mt-6 leading-8 text-zinc-700">
                                    In 1937 is toestemming van die T.O.D verkry om met die eerste matriekklas te begin... Die Hoërskool Brits het eers op 4 Augustus 1942 volwaardige hoërskoolstatus gekry. Mnr. T. le Roux was die hoof oor 17 personeellede en 329 leerlinge... Die primêre- en sekondêre afdeling sou voortaan as twee aparte skole funksioneer.
                                </p>
                            </div>
                        </div>

                        {/* Onderwerp 2: Skoolkode & Skoollied */}
                        {/* REGSTELLING: Bygevoeg 'prose-h2:text-rose-900' en teks opgebreek in <p> etikette */}
                        <div className="prose prose-lg prose-zinc mx-auto max-w-3xl text-center prose-h2:text-rose-900">
                            ...
                            <div className="mt-16">
                                ...
                                <div className="mt-6 leading-8 text-zinc-700">
                                    <p>
                        ...
                        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:items-center">
                            <div className="relative mx-auto w-64 h-96 overflow-hidden rounded-lg shadow-xl md:h-150 md:w-110">
                                <Image
                                    src="/ou_wapen.webp" // Hierdie prent moet in /public wees
                                    alt="Ou Wapen"
                                    fill
                                    className="object-contain" // 'object-contain' pas die prent binne-in die boks
                                />
                            </div>
                            <div className="prose prose-lg prose-zinc prose-h2:text-rose-900">
                                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-center text-rose-900">
                                    Geskiedenis van die oorspronklike wapen
                                </h2>
                                <p className="mt-6 leading-8 text-zinc-700">
                                    Daar is dadelik daadwerklike pogings aangewend om 'n gepaste wapen te kry. In die ontwerp moes besonderhede wat tipies van die omgewing is, ingewerk word &dash; daarbenewens moes die ontwerp ook aansluit by die leuse: “MY DOODKRY IS MIN”.  Dit was die poging van Mej. S.M. Schiel, destydse onderwyseres in Natuurwetenskappe, wat met sukses bekroon is. (1947).
                                </p>
                                <h2 className="mt-8 text-3xl font-bold tracking-tight sm:text-4xl text-center text-rose-900">
            ...
            <section className="bg-rose-900 py-16 sm:py-20">
                ...
                >
                    ...
                    <p className="mt-4 text-lg text-rose-100">
                        Word deel van ons trotse tradisie en begin vandag nog jou aansoek.
                    </p>
                    <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        ...
                        <Link
                            href="/kontak" // Ons moet nog hierdie bladsy bou
